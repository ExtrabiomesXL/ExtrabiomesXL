...
public class CraftBlock implements Block {
    ...
    static {
        ...
        BIOME_MAPPING[CustomBiomeManager.alpine.id] = Biome.ALPINE;
        BIOME_MAPPING[CustomBiomeManager.autumnWoods.id] = Biome.AUTUMN_WOODS;
        BIOME_MAPPING[CustomBiomeManager.birchForest.id] = Biome.BIRCH_FOREST;
        BIOME_MAPPING[CustomBiomeManager.extremeJungle.id] = Biome.EXTREME_JUNGLE;
        BIOME_MAPPING[CustomBiomeManager.forestedHills.id] = Biome.FORESTED_HILLS;
        BIOME_MAPPING[CustomBiomeManager.forestedIsland.id] = Biome.FORESTED_ISLAND;
        BIOME_MAPPING[CustomBiomeManager.glacier.id] = Biome.GLACIER;
        BIOME_MAPPING[CustomBiomeManager.greenHills.id] = Biome.GREEN_HILLS;
        BIOME_MAPPING[CustomBiomeManager.greenSwamp.id] = Biome.GREEN_SWAMP;
        BIOME_MAPPING[CustomBiomeManager.iceWasteland.id] = Biome.ICE_WASTELAND;
        BIOME_MAPPING[CustomBiomeManager.marsh.id] = Biome.MARSH;
        BIOME_MAPPING[CustomBiomeManager.meadow.id] = Biome.MEADOW;
        BIOME_MAPPING[CustomBiomeManager.miniJungle.id] = Biome.MINI_JUNGLE;
        BIOME_MAPPING[CustomBiomeManager.mountainDesert.id] = Biome.MOUNTAIN_DESERT;
        BIOME_MAPPING[CustomBiomeManager.mountainRidge.id] = Biome.MOUNTAIN_RIDGE;
        BIOME_MAPPING[CustomBiomeManager.mountainTaiga.id] = Biome.MOUNTAIN_TAIGA;
        BIOME_MAPPING[CustomBiomeManager.pineForest.id] = Biome.PINE_FOREST;
        BIOME_MAPPING[CustomBiomeManager.rainForest.id] = Biome.RAINFOREST;
        BIOME_MAPPING[CustomBiomeManager.redwoodForest.id] = Biome.REDWOOD_FOREST;
        BIOME_MAPPING[CustomBiomeManager.redwoodLush.id] = Biome.REDWOOD_LUSH;
        BIOME_MAPPING[CustomBiomeManager.savanna.id] = Biome.SAVANNA;
        BIOME_MAPPING[CustomBiomeManager.shrubLand.id] = Biome.SHRUBLAND;
        BIOME_MAPPING[CustomBiomeManager.snowForest.id] = Biome.SNOW_FOREST;
        BIOME_MAPPING[CustomBiomeManager.snowRainForest.id] = Biome.SNOWY_RAINFOREST;
        BIOME_MAPPING[CustomBiomeManager.temperateRainForest.id] = Biome.TEMPORATE_RAINFOREST;
        BIOME_MAPPING[CustomBiomeManager.tundra.id] = Biome.TUNDRA;
        BIOME_MAPPING[CustomBiomeManager.wasteland.id] = Biome.WASTELAND;
        BIOME_MAPPING[CustomBiomeManager.woodlands.id] = Biome.WOODLANDS;
