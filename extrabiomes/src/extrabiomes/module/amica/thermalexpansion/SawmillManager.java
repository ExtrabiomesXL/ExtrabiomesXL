...
class SawmillManager {
	...
	SawmillManager(Object sawmill) throws Exception {
		...
		addRecipe = Optional.fromNullable(sawmill.getClass().getMethod(
				"addRecipe", Integer.TYPE, ItemStack.class,
				ItemStack.class, ItemStack.class, Integer.TYPE));
	}

	boolean addRecipe(int energy, ItemStack input,
	...
	{
		return addRecipe(energy, input, primaryOutput, secondaryOutput,
				100);
	}
	...
	{
		try {
			addRecipe.get().invoke(sawmill, energy, input, primary,
