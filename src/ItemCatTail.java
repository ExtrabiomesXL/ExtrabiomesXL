...
public class ItemCatTail extends Item
{
    ...
    public ItemCatTail(int par1, Block par2Block)
    {
        super(par1);
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7)
    {
        ...
        if (par3World.canBlockBePlacedAt(spawnID, par4, par5, par6, false, par7))
        {
            ...
            if (par3World.setBlockWithNotify(par4, par5, par6, spawnID))
            {
                ...
                par3World.playSoundEffect((float)par4 + 0.5F, (float)par5 + 0.5F, (float)par6 + 0.5F, block.stepSound.getStepSound(), (block.stepSound.getVolume() + 0.5F) / 2.0F, block.stepSound.getPitch() * 1.3F);
