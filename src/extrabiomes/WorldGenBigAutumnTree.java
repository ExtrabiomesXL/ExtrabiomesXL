...
public class WorldGenBigAutumnTree extends WorldGenerator {
	...
	public WorldGenBigAutumnTree(final boolean doBlockNotify,
		...
		if (wood == null)
			throw new NullPointerException("Wood cannot be null.");
		...
		if (var4[var6] != 0) {
			...
			for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
				...
				this.setBlockAndMetadata(worldObj, var14[0], var14[1],
						var14[2], woodBlock.blockId(), woodBlock.metadata());
			}
		}
	}
