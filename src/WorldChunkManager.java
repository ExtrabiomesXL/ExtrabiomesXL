...
public class WorldChunkManager
{
    ...
    protected WorldChunkManager()
    {
        ...
        this.biomesToSpawnIn.add(BiomeGenBase.jungleExtreme);
        this.biomesToSpawnIn.add(BiomeGenBase.alps);
        this.biomesToSpawnIn.add(BiomeGenBase.autumnWoods);
        this.biomesToSpawnIn.add(BiomeGenBase.birchForest);
        this.biomesToSpawnIn.add(BiomeGenBase.mountainRidge);
        this.biomesToSpawnIn.add(BiomeGenBase.desertMountain);
        this.biomesToSpawnIn.add(BiomeGenBase.forestedHills);
        ...
        this.biomesToSpawnIn.add(BiomeGenBase.shrubland);
        this.biomesToSpawnIn.add(BiomeGenBase.snowForest);
        this.biomesToSpawnIn.add(BiomeGenBase.taigaMountain);
        this.biomesToSpawnIn.add(BiomeGenBase.temperateRainforest);
        this.biomesToSpawnIn.add(BiomeGenBase.temperateRainforestSnow);
        this.biomesToSpawnIn.add(BiomeGenBase.wasteland);
        this.biomesToSpawnIn.add(BiomeGenBase.woodlands);
        this.biomesToSpawnIn.add(BiomeGenBase.redwoodForest);
        this.biomesToSpawnIn.add(BiomeGenBase.redwoodLush);
        this.biomesToSpawnIn.add(BiomeGenBase.marsh);
        this.biomesToSpawnIn.add(BiomeGenBase.pineForest);
        this.biomesToSpawnIn.add(BiomeGenBase.tundra);
    }

    public WorldChunkManager(long par1, WorldType par3WorldType)
    {
        this();
        GenLayer[] var4 = GenLayer.func_48425_a(par1, par3WorldType);
