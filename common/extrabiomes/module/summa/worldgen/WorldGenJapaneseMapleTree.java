...
public class WorldGenJapaneseMapleTree extends WorldGenNewTreeBase {
    ...
    private boolean generateTree(World world, Random rand, int x, int y, int z) {
        ...
        if(place1x1Trunk(x, y, z, (int)(height * TRUNK_HEIGHT_PERCENT), TreeBlock.TRUNK.get(), world)) {
	        ...
	        generateBranches(world, rand, x, y + (int)(height * TRUNK_HEIGHT_PERCENT), z, height - (int)(height * TRUNK_HEIGHT_PERCENT) - 2);
    ...
    public void generateBranches(World world, Random rand, int x, int y, int z, int height) {
    	...
    	double radius = (CANOPY_WIDTH + rand.nextInt(CANOPY_WIDTH_VARIANCE)) / 2.0D;
